...
foreach(_LANGUAGE ${LANGUAGE_LIST})
    ...
    execute_process(
        COMMAND ${CMAKE_COMMAND} -E env
                ...
                -D html_theme_options.show_version_warning_banner=0 # Hide the version warning banner.
...
set(UPSTREAM_DOCS   "https://numpy.org/doc")
set(UPSTREAM_REPO   "https://github.com/numpy/numpy")
set(INSERT_POINT    "[class=\"bd-article\"]")
